...
DATASETS = {
	...
	"PMT_encode": {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['PMT_train'],
		'train_target_root': dataset_paths['PMT_train'],
		'test_source_root': dataset_paths['PMT_test'],
		'test_target_root': dataset_paths['PMT_test']
	}
}
