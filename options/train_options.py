...
class TrainOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--exp_dir', default='./PMT_experiment_ffhq_1', type=str, help='Path to experiment output directory')
        self.parser.add_argument('--dataset_type', default='PMT_encode', type=str,
        ...
        # Discriminator flags
        self.parser.add_argument('--w_discriminator_lambda', default=0.1, type=float, help='Dw loss multiplier')
        ...
        self.parser.add_argument('--use_w_pool', default=True, action='store_true',
        ...
        self.parser.add_argument('--keep_optimizer', default=True, action='store_true',
        ...
        self.parser.add_argument('--update_param_list', nargs='+', type=str, default=['batch_size', 'test_batch_size', 'workers', 'test_workers', 'save_interval'],
